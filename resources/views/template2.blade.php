    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="index.html">
          <img src="{{url('public/assets/images/logo-mini.svg')}}" alt="logo" />
        </a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="images/faces/logo.jpg" alt="Profile image">
            </a>
        ...
        <ul class="nav">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  <img src="{{url('public/assets/images/logo.jpg')}}" alt="profile image">
                </div>
                <div class="text-wrapper">
                  <p class="profile-name">nKopi</p>
                  <div>
                    <small class="designation text-muted">Admin nKopi</small>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('menuadmin')}}">
              ...
              <span class="menu-title">Data nKopi</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{url('login')}}" aria-expanded="false" aria-controls="auth">
